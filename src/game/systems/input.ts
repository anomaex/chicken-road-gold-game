...
export function initInput() {
  ...
  const endDrag = (e: FederatedPointerEvent) => {
    ...
    // Если мы почти не двигали мышкой и нажали быстро — это клик
  ...
  app.stage.on("pointerup", (e: FederatedPointerEvent) => endDrag(e));
  app.stage.on("pointerupoutside", (e: FederatedPointerEvent) => endDrag(e));
}
